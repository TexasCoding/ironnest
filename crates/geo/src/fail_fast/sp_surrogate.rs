...
use crate::fail_fast::{piers, pole};
use crate::geo_traits::{Transformable, TransformableFrom};
...
/// Configuration of the [`SPSurrogate`](crate::fail_fast::SPSurrogate) generation
...
pub struct SPSurrogateConfig {
    ...
    pub n_pole_limits: [(usize, Scalar); N_POLE_LIMITS],
